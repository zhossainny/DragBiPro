...
import WidgetEditor from "./MetricWidgetEdit";
...
class MetricWidgetContainer extends React.Component {
    ...
    render() {
        this.state.settings.controlType = 'metric'
        let editing = this.isEditing();
        ...
        return (
            <Container className={'widgetContainer'} id={this.props.glContainer.parent.config.id}>
                ...
                {!editing && !showError && <MetricsWidget
                    id={this.state.uid}
...
MetricWidgetContainer.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(MetricWidgetContainer);
