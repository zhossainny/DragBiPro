...
import PercentagePieOptions from "./percentagePie/PercentagePieOptions";
...
class WidgetEditor extends React.Component {
    ...
    constructor(props) {
        ...
        this.chartSettingsChanged = this.chartSettingsChanged.bind(this);
        ...
        this.percentageSettingsChanged = this.percentageSettingsChanged.bind(this);
    }
    ...
    chartSettingsChanged(settings) {
        this.props.onSettingsChanged({ ...this.props.settings, chart: settings });
    }
    ...
    percentageSettingsChanged(settings) {
        this.props.onSettingsChanged({ ...this.props.settings, percentage: settings });
    }
    ...
    getChartOptions() {
        if (this.props.settings.controlType !== "chart") {
            return null;
        }

        return (<ChartOptions
            settings={this.props.settings.chart}
            columnNames={this.props.settings.columnNames} 
            onSettingsChanged={this.chartSettingsChanged}
        />);
    }
    ...
    getPercentageOptions() {
        if (this.props.settings.controlType !== "percentage_pie") return null;
        return (<PercentagePieOptions
            settings={this.props.settings.percentage}
            jsonProperties={this.props.settings.jsonProperties}
            onSettingsChanged={this.percentageSettingsChanged}
        />);
    }

    hasAdvancedOptions = () => {
        return this.state.advancedOptionsVisible && (this.props.settings.controlType === "grid" || this.props.settings.controlType === "chart");
    }
                            ...
                            <div className="col-sm-11">
                                {!this.props.dataError &&
                                    <DropDown onChange={this.controlChanged}
                                        ...
                                        <option value="">-- Select Widget Control --</option>
                                        <option value="grid">Grid</option>
                                        <option value="chart">Chart</option>
                                        <option value="metric">Metric</option>
                                        <option value="percentage_pie">Percentage</option>
