...
import WidgetEditor from "./GridWidgetEdit";
...
class GridWidgetContainer extends React.Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(GridWidgetContainer);
