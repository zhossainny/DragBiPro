import WidgetEditor from "./iframeWidgetEdit";
...
class iFrameWidgetContainer extends React.Component {
    ...
    render() {
        this.state.settings.controlType = 'external';
        let editing = this.isEditing();
        ...
        return (
            <Container className={'widgetContainer'} id={this.props.glContainer.parent.config.id}>
                ...
                {!editing && !showError &&  <IFrameWidget
                    id={this.state.uid}
...
iFrameWidgetContainer.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(iFrameWidgetContainer);
