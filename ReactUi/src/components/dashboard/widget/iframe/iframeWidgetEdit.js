...
class iframeWidgetEdit extends React.Component {
        ...
        return (
            <Container>
                ...
                <div className="container" style={{ marginLeft: "0px", width: "100%", background:"#262626", color:"white" }}>
                    ...
                    <HeaderMedium>iFrame - Another website/app inside</HeaderMedium>
                    <div className="row" >
...
export default iframeWidgetEdit;