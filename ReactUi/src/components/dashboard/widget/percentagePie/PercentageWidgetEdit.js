...
import PercentagePieOptions from "./PercentagePieOptions";

class PercentageWidgetEdit extends React.Component {
    ...
    render() {
        this.props.settings.controlType = 'percentage_pie';
        ...
        return (
            <Container>
                ...
                <div className="container" style={{ marginLeft: "0px", width: "100%", background:"#262626", color:"white" }}>
                    ...
                    <HeaderMedium>Percentage (json path value between 0-1)</HeaderMedium>
                    <div className="row" >
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-11">
                            ...
                            <DropDown onChange={this.controlChanged}
                                ...
                                <option value="">select only iFrame type</option>
...
PercentageWidgetEdit.propTypes = {
...
export default PercentageWidgetEdit;
