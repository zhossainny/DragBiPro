...
import PercentagePieWidget from "./PercentagePieWidget";

import WidgetEditor from "./PercentageWidgetEdit";

class PercentageWidgetContainer extends React.Component {
    ...
    render() {
        this.state.settings.controlType ='percentage_pie';
        let editing = this.isEditing();
        ...
        return (
            <Container className={'widgetContainer'} id={this.props.glContainer.parent.config.id}>
                ...
                {!editing && !showError && <PercentagePieWidget
                    id={this.state.uid}
...
PercentageWidgetContainer.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(PercentageWidgetContainer);
