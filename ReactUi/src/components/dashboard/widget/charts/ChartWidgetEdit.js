...
class ChartWidgetEdit extends React.Component {
    ...
    render() {
        this.props.settings.controlType = 'chart';
        ...
        return (
            <Container>
                ...
                <div className="container" style={{ marginLeft: "0px", width: "100%", background:"#262626", color:"white" }}>
                    ...
                    <HeaderMedium>Chart Settings (Explore many types)</HeaderMedium>
                    <div className="row" >
...
export default ChartWidgetEdit;